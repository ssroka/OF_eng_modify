...
#include "my_meanVelocityForce.H"
...
namespace fv
{
    defineTypeNameAndDebug(my_meanVelocityForce, 0);
...
void Foam::fv::my_meanVelocityForce::writeProps
(
    const scalar gradP
) const
{
...
Foam::fv::my_meanVelocityForce::my_meanVelocityForce
(
...
Foam::scalar Foam::fv::my_meanVelocityForce::magUbarAve
(
...
void Foam::fv::my_meanVelocityForce::correct(volVectorField& U)
{
...
void Foam::fv::my_meanVelocityForce::addSup
(
    fvMatrix<vector>& eqn,
    const label fieldi
)
...
void Foam::fv::my_meanVelocityForce::constrain
(
    fvMatrix<vector>& eqn,
    const label
)
