...
#include "my_patchMeanVelocityForce.H"
...
namespace fv
{
    defineTypeNameAndDebug(my_patchMeanVelocityForce, 0);

    addToRunTimeSelectionTable
    (
        option,
        my_patchMeanVelocityForce,
        dictionary
    );
}
}
...
Foam::fv::my_patchMeanVelocityForce::my_patchMeanVelocityForce
(
...
:
    my_meanVelocityForce(sourceName, modelType, dict, mesh),
...
Foam::scalar Foam::fv::my_patchMeanVelocityForce::magUbarAve
(
